// Initialize the map
const map = L.map('map').setView([45.519292, 11.338594], 8);
...
document.getElementById('text').addEventListener('click', function(event) {
    if (event.target && event.target.id.startsWith('sub-heading')) {
        ...
        if (targetId === 'sub-heading-1') {
            flyToAndClear(defaultCoordinates, 6);
...
handleButtonClick('05', [32, -130], 4, '<h1 class="montserrat-h1">05</h1><p class="montserrat-p">Video overlay</p>');
...
const videoUrl = 'https://user.eumetsat.int/s3/eup-strapi-media/vid_il_19_07_07_3_76b9938111.mp4';
